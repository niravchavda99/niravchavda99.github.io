...
export const RadioButton = ({defaultChecked, disabled, id, label, name, onChange, value}: RadioButtonProps) => {
    return (
        <div className="flex items-start gap-2">
            ...
            <label htmlFor={id} className={"hash-label text-start hover:cursor-pointer"}>
                {label}
            </label>
        </div>
    );
